...
def scrape_iros_titles_with_links():
    """爬取IROS 2024论文标题和DOI链接"""
    url = "https://dblp.org/db/conf/iros/iros2024.html"
    ...
    # 保存到CSV文件
    output_file = "/home/cuhk/Documents/Test_lx/Find_Paper/IROS2024/IROS2024_Title_DOI.csv"
